        ...
        <?php if ($_SESSION['nivel'] == 'Vendedor' || $_SESSION['nivel'] == 'Cliente'): ?>
            <form action="promociones.php" method="POST">
                ...
                <select name="promociones" required>
                    ...
                    <option value="Clase gratuita">Clase gratuita para nuevos usuarios</option>
                    <option value="Descuento para grupo">Descuento para grupos de 5 o más</option>
                    <option value="Abono mensual">Descuento en abono mensual</option>
                </select><br>
